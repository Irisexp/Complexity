...
class Q5_Page(Page):
    ...
    form_model = "player"
    form_fields = ["Q5_choice"]


class Results_5(Page):
    pass
...
page_sequence = [Recap, Color_Page, Summary, Q1_Page, Results_1, Q2_Page, Results_2, Q3_Page, Results_3, Q4_Page, Results_4, Q5_Page, Results_5, Results]
